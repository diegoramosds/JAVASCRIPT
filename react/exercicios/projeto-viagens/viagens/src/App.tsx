...
function removeEmailFroomInvites(emailToRemove : string) {
            ...
            <div className="space-y-4">
              ...
              {isGuestsInputOpen && (
                 ...
                 <button type="button" onClick={openGuestsModal} className="flex items-center gap-2 flex-1">
                   ...
                   <span className="text-zinc-400 text-lg flex-1">Quem vai estar na viagem?</span>
                     <input type="text" placeholder="" className="bg-transparent text-lg placeholder-zinc-400 outline-none w-40" />
                 </button>
                 ...
                 <div className="space-y-2">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {emailsToInvite.map((email) => {
                        return (
                        <div key={email} className="py-1.5 px-2.5 bg-zinc-800 flex items-center gap-2 rounded-md">
                        <span className="text-zinc-300">{email}</span>
                        <button type='button'><X onClick={() => removeEmailFroomInvites(email)} className="size-4"/></button>
                      </div> 
                        )
                      })} 
                    </div>
